...
namespace InvestQ.API.Controllers
{
    ...
    public class AtivoController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> GetAtivoByCaixa()
        {
            try
            {
                 var ativo = await _ativoService.GetAtivoByCaixaAsync();
            ...
            {
                return StatusCode(StatusCodes.Status500InternalServerError,
                            $"Erro ao tentar recuperar o Ativo CAIXA. Erro: {ex.Message}");
            }
        }

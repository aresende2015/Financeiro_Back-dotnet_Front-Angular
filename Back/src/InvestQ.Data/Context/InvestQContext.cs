...
namespace InvestQ.Data.Context
{
                                                    ...
                                                    IdentityUserToken<int>>
    {
        ...
        public DbSet<TaxaDeNegociacao> TaxasDeNegociacoes { get; set; }
        public DbSet<TaxaDeIR> TaxasDeIR { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.ApplyConfiguration(new TaxaDeNegociacaoMap());
            builder.ApplyConfiguration(new TaxaDeIRMap());
